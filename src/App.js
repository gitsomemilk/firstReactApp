           ...
           <nav>
            ...
            <main>
                <article className="product">
                    ...
                    <p>Een citroen is voor de meeste mensen te zuur om zo uit de hand te eten. Van citroen kun je het
                ...
                <article className="product">
                    ...
                    <p>Limoen is familie van de citroen en de sinaasappel en behoort tot de citrusvruchten
                ...
                <article className="product">
                    ...
                    <p>Een ijsblokje of ijsklontje is bevroren water in de vorm van een klein blokje. Het wordt gemaakt
